...
. 설치를 위해 적절한 MySQL 리포지토리를 다운로드합니다. `+wget http://repo.mysql.com/yum/mysql-8.0-community/el/7/x86_64/mysql80-community-release-el7-3.noarch.rpm+`
. MySQL 리포지토리 구성: `yum install mysql80-community-release-el7-3.noarch.rpm`
